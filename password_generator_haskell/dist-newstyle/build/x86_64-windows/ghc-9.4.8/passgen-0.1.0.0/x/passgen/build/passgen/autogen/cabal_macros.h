...
/* package passgen-0.1.0.0 */
#ifndef VERSION_passgen
#define VERSION_passgen "0.1.0.0"
#endif /* VERSION_passgen */
#ifndef MIN_VERSION_passgen
#define MIN_VERSION_passgen(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_passgen */
...
#define CURRENT_COMPONENT_ID "passgen-0.1.0.0-inplace-passgen"
